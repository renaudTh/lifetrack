...
describe("Calendar", () => {
  describe("constructor", () => {
    it("should initialize currentMonth to the first day of the provided month", () => {
      ...
      expect(calendar.currentMonth.isSame(dayjs("2024-03-01"), "day")).toBe(true);
    });
  ...
  describe("nextMonth", () => {
    it("should move the currentMonth to the next month", () => {
      ...
      expect(calendar.currentMonth.isSame(dayjs("2024-02-01"), "day")).toBe(true);
    });
  });
  ...
  describe("previousMonth", () => {
    it("should move the currentMonth to the previous month", () => {
      ...
      expect(calendar.currentMonth.isSame(dayjs("2024-01-01"), "day")).toBe(true);
    });
  });
  ...
  describe("daysOfMonths", () => {
    it("should generate the correct number of days including days outside the current month", () => {
      ...
      const daysBefore = days.filter((day) => !day.inCurrentMonth && day.date.isBefore(customMonth, "month"));
      ...
      const daysAfter = days.filter((day) => !day.inCurrentMonth && day.date.isAfter(customMonth, "month"));
