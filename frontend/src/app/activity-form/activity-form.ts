...
export class ActivityForm {
  ...
  activityForm = computed(() => {
    ...
    return new FormGroup({
      representation: new FormControl<string>(v.representation, { validators: [Validators.required] }),
      base_amount: new FormControl<number>(v.base_amount, { validators: [Validators.required] }),
      description: new FormControl(v.description, { validators: [Validators.required] }),
